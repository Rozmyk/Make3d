...
type HomeView = "categories" | "organizers" | "cable-management" | "desk-mounts" | "mounting" | "pegboard" | "spacers" | "washers";
const premiumEase = [0.16, 1, 0.3, 1] as const;

function viewFromLocation(): HomeView {
  const category = new URLSearchParams(window.location.search).get("category");
  return category === "organizers" || category === "cable-management" || category === "desk-mounts" || category === "mounting" || category === "pegboard" || category === "spacers" || category === "washers" ? category : "categories";
}
...
export function GeneratorHome() {
  ...
  return <motion.main className="projectsHome" {...enter()}>
    ...
    {view === "categories" ? <>
      ...
      <section className="projectsIntro projectsIntro--compact" aria-labelledby="projects-title"><h1 id="projects-title">Mount it<br />with confidence.</h1><p>Create fitted brackets and finishing parts for clean, strong hardware installations.</p></section>
      ...
      <section className="projectsIntro projectsIntro--compact" aria-labelledby="projects-title"><h1 id="projects-title">Create the exact<br />gap you need.</h1><p>Configure a printable spacer for a precise mounting distance, with an optional centre hole and support flange.</p></section>
      ...
      <section className="projectsIntro projectsIntro--compact" aria-labelledby="projects-title"><h1 id="projects-title">Fit every fastener<br />just right.</h1><p>Create a flat or countersunk washer with dimensions matched to your screw and mounting surface.</p></section>
